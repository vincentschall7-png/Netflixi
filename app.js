...
function renderFolderList() {
    ...
    folders.forEach(folder => {
        ...
        folderItem.innerHTML = \
            ...
            <button class="folder-delete" data-folder-id="\" title="L�schen"></button>
        \;
...
async function deleteFolder(folderId) {
    // Request password
    const password = prompt('Passwort zum L�schen des Ordners eingeben:');
    ...
    if (!confirm(\Ordner "\" und alle \ Videos darin wirklich l�schen?\)) {
        return;
    }
